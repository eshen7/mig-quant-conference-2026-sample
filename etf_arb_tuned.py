"""
Combined ETF Stat Arb: All Three Improvements + Elastic Net
============================================================

Combines improvements over strategy_combined.py:

1. Elastic net regression (L1+L2) replacing ridge — sparsifies basket weights
2. Volatility-scaled position sizing
3. Tighter exit thresholds (exit_threshold=0.008, k_exit=0.2)
4. Circuit breaker (per-pair PnL kill switch, portfolio drawdown protection)
"""
